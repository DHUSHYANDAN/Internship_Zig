...
function EmployeeList() {
  ...
  const exportExcel = () => {
    ...
    const filteredEmployees = employees.map(
      ({ _id, hire_date, id, __v, ...rest }) => rest
    );
              ...
              <thead className="text-xs uppercase bg-blue-400 text-white sticky top-0">
                <tr>
                  <th className="px-4 py-3 " onClick={() => requestSort("name")}>
                    Name
                    <svg
                      className={`inline-block h-4 w-4 ml-1 transition-transform duration-300 ${
                  ...
                  <th className="px-4 py-3" onClick={() => requestSort("employee_id")}>
                    Emp Id
                    <svg
                      className={`inline-block h-4 w-4 ml-1 transition-transform duration-300 ${
                        sortConfig.key === "employee_id" && sortConfig.direction === "ascending"
                          ? "transform rotate-180"
                          : ""
                      }`}
                      stroke="currentColor"
                  ...
                  <th className="px-4 py-3" onClick={() => requestSort("department_name")}>
                    Department
                    <svg
                      className={`inline-block h-4 w-4 ml-1 transition-transform duration-300 ${
                        sortConfig.key === "department_name" && sortConfig.direction === "ascending"
                          ? "transform rotate-180"
                          : ""
                      }`}
                      stroke="currentColor"
          ...
          theme={{
            pages: {
              ...
              selector: {
                ...
                active:
                  "bg-cyan-50 text-cyan-600 hover:bg-cyan-100 hover:text-cyan-700 dark:bg-gray-700 dark:text-white",
